...
/**
 * The factory to create {@link KeyedBroadcastMultipleInputStreamJoinOperator}.
 *
 * @author Quentin Qiu
 */
public class KeyedBroadcastMultipleInputStreamJoinOperatorFactory
    ...
    public KeyedBroadcastMultipleInputStreamJoinOperatorFactory(
            int numberOfInputs,
    ...
    public <T extends StreamOperator<RowData>> T createStreamOperator(
        ...
        return (T)
                new KeyedBroadcastMultipleInputStreamJoinOperator(
                        parameters,
                        numberOfInputs,
                        inputSideSpecs,
                        internalTypeInfos,
