...
/** Utility to create a {@link AbstractMultipleInputJoinRecordStateView} depends on {@link JoinInputSideSpec}.
 * @author Quentin Qiu*/
public final class MultipleInputJoinRecordStateViews {
    ...
    public static AbstractMultipleInputJoinRecordStateView create(
        ...
        if (inputSideSpec.hasUniqueKey()) {
            if (inputSideSpec.joinKeyContainsUniqueKey()) {
                return new MultipleInputJoinKeyContainsUniqueKey(ctx, stateName, recordType, ttlConfig);
            } else {
    ...
    private static final class MultipleInputJoinKeyContainsUniqueKey extends AbstractMultipleInputJoinRecordStateView {
    ...
    private static final class MultipleInputInputSideHasUniqueKey extends AbstractMultipleInputJoinRecordStateView {
    ...
    private static final class MultipleInputInputSideHasNoUniqueKey extends AbstractMultipleInputJoinRecordStateView {
