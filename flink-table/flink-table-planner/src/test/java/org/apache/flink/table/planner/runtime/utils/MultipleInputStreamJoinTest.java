...
public class MultipleInputStreamJoinTest extends TestLogger {
    ...
    public HashMap<String,String> getTpchQueries(){
        ...
        String Q16="select\n"
                ...
                + "        p_type,\n"
                + "        p_size;";
        String Q15="with revenue0(supplier_no, total_revenue)  as\n"
                + "    (\n"
                + "    select\n"
                + "        l_suppkey,\n"
    ...
    public HashMap<String,String> getSinkTables(){
        ...
        String sinkTableQ9 =
                "CREATE TABLE sink_table_q9 (\n" +
                        ...
                        "    'connector' = 'blackhole'\n" +
                        ");";
        String sinkTableQ10 = "CREATE TABLE sink_table_q10 (\n" +
                "    c_custkey BIGINT,\n" +
                "    c_name STRING,\n" +
                "    revenue DECIMAL(38, 2),\n" +
                ...
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ11 = "CREATE TABLE sink_table_q11 (\n" +
                "ps_partkey INT, "
                + "value11 DECIMAL(38, 2)"+
                ") WITH (\n" +
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ12 = "CREATE TABLE sink_table_q12 (\n" +
                "    l_shipmode STRING,\n" +
                ...
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ13 = "CREATE TABLE sink_table_q13 (\n" +
                "    c_custkey BIGINT,\n" +
                "    c_count BIGINT\n" +
                ") WITH (\n" +
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ14 = "CREATE TABLE sink_table_q14 (\n" +
                "promo_revenue DECIMAL(38, 6)" +
                ") WITH (\n" +
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ15 = "CREATE TABLE sink_table_q15 (\n" +
               "s_suppkey INT, "
                + "s_name CHAR(25), "
                + "s_address VARCHAR(40), "
                + "s_phone CHAR(15), "
                ...
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ16 = "CREATE TABLE sink_table_q16 (\n" +
                "    p_brand STRING,\n" +
                "    p_type STRING,\n" +
                "    p_size INT,\n" +
                "    supplier_cnt BIGINT\n" +
                ...
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ17 = "CREATE TABLE sink_table_q17 (\n" +
                "avg_yearly DECIMAL(38, 6)" +
                ") WITH (\n" +
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ18 = "CREATE TABLE sink_table_q18 (\n" +
                "c_name VARCHAR(25), "
                + "c_custkey INT, "
                + "o_orderkey INT, "
                + "o_orderdate DATE, "
                ...
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ19 = "CREATE TABLE sink_table_q19 (\n" +
                "revenue DECIMAL(38, 4)" +
                ") WITH (\n" +
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ20 = "CREATE TABLE sink_table_q20 (\n" +
                "    p_name STRING,\n" +
                "    p_price DECIMAL(38, 2),\n" +
                "    s_name STRING,\n" +
                "    s_address STRING,\n" +
                "    s_phone STRING,\n" +
                "    s_comment STRING\n" +
                ...
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ21 = "CREATE TABLE sink_table_q21 (\n" +
                "    s_name STRING,\n" +
                "    count_order BIGINT\n" +
                ") WITH (\n" +
                "    'connector' = 'blackhole'\n" +
                ");";
        String sinkTableQ22 = "CREATE TABLE sink_table_q22 (\n" +
                "    cntrycode STRING,\n" +
                "    numcust BIGINT,\n" +
